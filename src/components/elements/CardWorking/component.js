      ...
      <div>
        <section className="text-gray-200 bg-gray-100">
          <div className="flex flex-wrap sm:m-4 mx-4 mb-10 mt-4">
            ...
            {data.map((item, index) => {
              return (
                <div className="p-10 lg:w-1/3 lg:mb-0 mb-6 flex flex-col">
                  <div key={index} className="pattern-dots-md bg-primary text-slate-900">
                      ...
                      <div className='bg-white h-32 relative'>
                        ...
                        <div className='text-center absolute top-20 right-0 left-0'>
                          <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-gray-100 mb-5 flex-shrink-0 p-2">
                            <Image width={55} height={55} src={item.icon} />
                          </div>
                        </div>
                      </div>
